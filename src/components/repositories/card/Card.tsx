    ...
    return (
      <div className="card">
        ...
        <div className="card__body">
          <div className={"card__body__stars"}>STARS: <span className={"card__body__stars--star-color"}>{stars}</span> <img src={starIcon} alt={"star"}/></div>
          <div className={"card__body__link-to-repo"}>
            <a href={repositoryUrl} rel="noopener noreferrer" target="_blank">Link To Repository</a>
          </div>
        </div>
      </div>
    )
